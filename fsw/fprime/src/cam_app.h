...
/*
** This is the specified pipe depth for the app, meaning how many messages will
*be
...
** This struct would be defined in the cam_app.h file. You would then have one
*global instance
** in the.c file. You would also extern the global struct in the header file.
*This is important for
** the Unit Test Framework(UTF). When using the UTF, you need access to the app
*global data so
** it's a good idea to play along.
*/
typedef struct {
  /*
  ** Housekeeping telemetry packet...each app defines its own packet which
  *contains
